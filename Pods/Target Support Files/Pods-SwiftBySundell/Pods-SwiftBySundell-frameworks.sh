...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/Localize-Swift-iOS11.0/Localize_Swift.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/NSVLocalizationKit-iOS11.0/NSVLocalizationKit.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/paper-onboarding-iOS11.0/paper_onboarding.framework"
fi
