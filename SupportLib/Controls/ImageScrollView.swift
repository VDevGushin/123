...
public struct ImageScrollViewConfigurator {
...
public class ImageScrollView: UIScrollView {
    ...
    @objc public func display(image: UIImage, firstTime: Bool = true) {
    ...
    //MARK - Settings
    public func setImageContentMode(_ mode: ImageScrollViewConfigurator.ImageContentMode) {
        configurator.imageContentMode = mode
    }

    public func setInitialOffset(_ offset: ImageScrollViewConfigurator.Offset) {
